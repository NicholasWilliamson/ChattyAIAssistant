...
class ChattyAIWebServer:
    ...
    def setup_socket_events(self):
        ...
        def handle_connect():
            ...
            self.clients.add(request.sid if 'request' in globals() else 'unknown')
            ...
            emit('system_info', self.get_system_info())

        @self.socketio.on('disconnect')
        def handle_disconnect():
            """Handle client disconnection"""
            self.clients.discard(request.sid if 'request' in globals() else 'unknown')
