...
BORED_RESPONSE_INTERVAL = 30  # NEW: Configurable duration for bored responses
...
class ChattyAI:
    def __init__(self):
        ...
        self.current_person = None  # NEW: Variable to store detected person's name
        ...
        self.bored_responses = []  # NEW: Generic bored responses
        self.visitor_greeting_responses = []  # NEW: Visitor greetings for daytime
    ...
    def load_response_files(self):
        ...
        try:
            ...
            # NEW: Load visitor greeting responses
            try:
    ...
    def create_default_visitor_responses(self):
        ...
        default_visitor = [
            ...
            "Welcome. I don't believe we've met. What can I do for you?",
            "Hello there. I'm an AI assistant. How can I assist you?",
            "Good to meet you. I don't recognize your face, but I'm happy to help."
        ]
