#!/usr/bin/env python3
"""
Chatty AI Assistant Web Version
...
class FastChattyAI:
    def __init__(self):
        ...
        print("Chatty AI initialised successfully!")
    ...
    def start_system(self):
        ...
        if not self.picam2:
            self.emit_log("Camera not initialised - attempting to setup...", 'warning')
...
if __name__ == '__main__':
    print("Chatty AI Web Server Starting...")
    print("=" * 60)
    print("✨ Optimised for maximum speed and performance")
